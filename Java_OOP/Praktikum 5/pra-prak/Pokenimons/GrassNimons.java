...
public class GrassNimons extends Pokenimons implements RangedAttacker {
  ...
  public Pokenimons evolve() {
    if(isFainted()){
      System.out.println(name + " has fainted and cannot evolve.");
    }else if(this instanceof GrassEvoNimons){
      System.out.println(name + " is already in final form.");
    }else if(getLevel() >= 5){
      System.out.println(name + " evolves into GrassEvoNimons!");
