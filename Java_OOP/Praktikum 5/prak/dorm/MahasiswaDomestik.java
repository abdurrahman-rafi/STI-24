public final class MahasiswaDomestik extends Mahasiswa{
    ...
    public void perkenalkan(){
        // TODO: answer here
        System.out.println("Halo, saya mahasiswa domestik " + gender.toString() + " dengan username " + getUsername());
    }
    ...
    public void daftarAsrama(Asrama asrama) {
        // TODO: answer here
        System.out.println("Mahasiswa domestik " + gender.toString() + " dengan username " + getUsername() + " berhasil mendaftar asrama");
