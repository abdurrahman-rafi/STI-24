...
public final class GedungKidangPananjung implements Asrama {
    ...
    public void daftarAsrama(Mahasiswa mhs) {
        ...
        }else if(mhss.getGender() == Gender.WANITA){
            System.out.println("Asrama Gedung Kidang Pananjung hanya untuk mahasiswa laki-laki");return;
        }else{
            penghuni.add(mhss);
            System.out.println("Mahasiswa "+ mhss.getUsername() + " diterima di asrama Gedung Kidang Pananjung");
            mhss.setAsrama(this);return;
        }
    }
}