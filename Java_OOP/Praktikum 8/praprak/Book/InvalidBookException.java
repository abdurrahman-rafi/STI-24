...
//    Jika invalidValue null, jangan tampilkan bagian "Value: ..."
    ...
    public String getMessage(){
        ...
        return String.format("%s (Book: '%s', Invalid Field: %s, Value: '%s')", 
            super.getMessage(), bookTitle, invalidField, invalidValue);
    } else {
        return String.format("%s (Book: '%s', Invalid Field: %s)", 
            super.getMessage(), bookTitle, invalidField);
    }
    }
