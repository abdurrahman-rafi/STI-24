...
public class Library {
  ...
  //     * Tambah book ke array, increment bookCount
    public void addBook(Book book){
      ...
      if(bookCount >= books.length){
        throw new IllegalStateException("Lib Full ");
      }
  ...
  //     * members.put(member.getMemberId(), member)
    public void registerMember(Member member) throws LibraryException{
      if(member == null){
        throw new LibraryException("Null member.", "INVALID_MEMBER");
      }

      if(members.containsKey(member.getMemberId())){
        throw new LibraryException("Member is already registered.", "DUPLICATE_MEMBER");
      }
  ...
  //     * Return member
    public Member findMember(String memberId) throws LibraryException{
      ...
      Member output = members.get(memberId);

      if(output == null){
        throw new LibraryException("Member doesn't exist", "MEMBER_NOT_FOUND");
      }
  ...
  //     * Return book jika ditemukan, null jika tidak
    public Book findBookByISBN(String isbn) throws InvalidBookException{
      if(isbn == null || isbn.trim().isEmpty()){
        throw new InvalidBookException("ISBN cannot be empty", null, "isbn", isbn);
      }
  ...
  public void returnBook(String memberId, String bookTitle) throws LibraryException{
    ...
    try {
      ...
      member.returnBook(bookTitle);  // This was missing
      book.returnBook();
  ...
  //        - Design Patterns
    public void displayMemberBooks(String memberId) throws LibraryException{
      ...
      if(member.getCurrentBorrowedCount() == 0){
        ...
        for(String b : member.getBorrowedBooks()){
