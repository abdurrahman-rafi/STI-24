...
public class LiveStream implements Playable {
    ...
    public void play() {
        if(isLive()){
            updateViewerCount();
            System.out.println(String.format("Menonton live stream: %s by %s - %d viewers", getTitle(), getStreamerName(), getViewerCount()));
            isPlaying = true;
        }else{
    ...
    @Override
    public void stop() {
        System.out.println("Keluar dari live stream "+ getTitle());
        isPlaying = false;
        updateViewerCount();
    }
    ...
    public void endStream() {
        isLive = false;
        isPlaying = false;
        System.out.println("Live stream "+ getTitle() + " telah berakhir");
    }
}