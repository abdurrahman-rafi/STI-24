...
public class DataAnalytics {
    ...
    public static <T> void copyData(Container <? extends T> source, Container<? super T> destination){
        System.out.println(String.format("Menyalin data dari %s ke %s...", source.getName(), destination.getName()));
        List<? extends T> list = source.getItems();
    ...
    public static <T> Container<T> mergeContainers(Container<?extends T> c1, Container<? extends T> c2, String newName){
        ...
        System.out.println(String.format("Menggabungkan %s dan %s...",c1.getName(), c2.getName()));
